    ...
    <div class="sidebar" data-color="orange" data-image="../assets/img/sidebar-7.jpg">
    	<div class="sidebar-wrapper">
            ...
            <ul class="nav">
                ...
                <li <?= ($hal=='desa' || $hal=='desa_olah')?'class="active"':'' ?>>
                    <a href="?hal=desa">
                ...
                <li <?= ($hal=='kriteria' || $hal=='kriteria_olah')?'class="active"':'' ?>>
                    <a href="?hal=kriteria">
                        <i class="pe-7s-user"></i>
                        <p>Olah Kriteria</p>
                    </a>
...
<!--                 <li <?= ($hal=='bobot_nilai' || $hal=='bobot_nilai_olah')?'class="active"':'' ?>>
                    <a href="?hal=bobot_nilai">
                        <i class="pe-7s-user"></i>
                        <p>Olah Bobot Nilai</p>
                    </a>
                </li> -->

                <li <?= ($hal=='kriteriadesa' || $hal=='kriteriadesa_olah')?'class="active"':'' ?>>
                    <a href="?hal=kriteriadesa">
                        <i class="pe-7s-user"></i>
                        <p>Olah Nilai Kriteria Desa</p>
                    </a>
                </li>                

                <li <?= ($hal=='berita' || $hal=='berita_olah')?'class="active"':'' ?>>
                    <a href="?hal=berita">
                        <i class="pe-7s-user"></i>
                        <p>Olah Berita</p>
                    </a>
