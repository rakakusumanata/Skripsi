    ...
    <div class="sidebar" data-color="orange" data-image="../assets/img/sidebar-7.jpg">
    	<div class="sidebar-wrapper">
            ...
            <ul class="nav">
                ...
                <li <?= ($hal=='perhitungan' || $hal=='tambah_perhitungan')?'class="active"':'' ?>>
                    <a href="?hal=perhitungan">
                ...
                <li <?= ($hal=='pemetaan_daerah'|| $hal=='detail_pemetaan')?'class="active"':'' ?>>
                    <a href="?hal=pemetaan_daerah">
                        <i class="pe-7s-user"></i>
                        <p>Pemetaan Daerah </p>
                    </a>
                    
                </li>
                 <li <?= ($hal=='berita'|| $hal=='berita_lihat')?'class="active"':'' ?>>
                 <li <?= ($hal=='berita')?'class="active"':'' ?>>
                     <a href="?hal=berita">
                        <i class="pe-7s-user"></i>
                        <p>Berita</p>
                    </a>
